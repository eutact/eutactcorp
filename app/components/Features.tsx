          ...
          {[
            {
              ...
              desc:
                "Build SaaS AI applications using OpenAI and Next.js, with pre-configured pages for a rapid start.",
              icon: "/window.svg",
            },
            {
              title: "Highly Customizable",
              desc:
                "Tailor every detail of your SaaS app effortlessly, with reusable components and flexible layout.",
              icon: "/globe.svg",
            },
          ].map(({ title, desc, icon }) => (
            <div
